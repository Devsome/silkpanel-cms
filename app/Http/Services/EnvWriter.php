...
class EnvWriter
{
    ...
    private function buildEnvContent(): string
    {
        ...
        $sections = [
            ...
            'Donation / Payment Providers' => ['DONATION_CURRENCY', 'PAYPAL_CLIENT_ID', 'PAYPAL_CLIENT_SECRET', 'PAYPAL_MODE', 'PAYPAL_WEBHOOK_ID', 'STRIPE_KEY', 'STRIPE_SECRET', 'STRIPE_WEBHOOK_SECRET', 'HIPOPAY_API_KEY', 'HIPOPAY_API_SECRET', 'HIPOCARD_API_KEY', 'HIPOCARD_API_SECRET', 'HIPOCARD_SILK_PER_UNIT'],
