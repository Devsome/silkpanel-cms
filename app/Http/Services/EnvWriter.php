...
class EnvWriter
{
    ...
    private function buildEnvContent(): string
    {
        ...
        $sections = [
            ...
            'Silkroad' => ['DB_SQL_HOST', 'DB_SQL_PORT', 'DB_SQL_USERNAME', 'DB_SQL_PASSWORD', 'DB_SQL_DATABASE_ACCOUNT', 'DB_SQL_DATABASE_LOG', 'DB_SQL_DATABASE_CERTIFICATION', 'DB_SQL_DATABASE_SHARD', 'DB_SQL_DATABASE_CUSTOM', 'DB_SQL_DATABASE_PORTAL'],
            ...
            'Donation / Payment Providers' => ['DONATION_CURRENCY', 'PAYPAL_CLIENT_ID', 'PAYPAL_CLIENT_SECRET', 'PAYPAL_MODE', 'PAYPAL_WEBHOOK_ID', 'STRIPE_KEY', 'STRIPE_SECRET', 'STRIPE_WEBHOOK_SECRET', 'HIPOPAY_API_KEY', 'HIPOPAY_API_SECRET', 'HIPOCARD_API_KEY', 'HIPOCARD_API_SECRET', 'HIPOCARD_SILK_PER_UNIT', 'MAXICARD_USERNAME', 'MAXICARD_PASSWORD', 'MAXICARD_SILK_PER_UNIT', 'FAWATERK_API_KEY', 'FAWATERK_VENDOR_KEY', 'FAWATERK_ENDPOINT'],
