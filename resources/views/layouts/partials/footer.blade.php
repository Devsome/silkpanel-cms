...
<footer class="bg-gray-100 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-auto">
    @if (is_array($partners) && count($partners) > 0)
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center gap-4">
                        @if ($socialFacebook)
                            <a href="{{ e($socialFacebook) }}" target="_blank" rel="noopener noreferrer"
                                class="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition"
                                title="Facebook">
                        ...
                        @if ($socialTwitter)
                            <a href="{{ e($socialTwitter) }}" target="_blank" rel="noopener noreferrer"
                                class="text-gray-500 hover:text-sky-500 dark:hover:text-sky-400 transition"
                                title="Twitter / X">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                        ...
                        @if ($socialInstagram)
                            <a href="{{ e($socialInstagram) }}" target="_blank" rel="noopener noreferrer"
                                class="text-gray-500 hover:text-pink-600 dark:hover:text-pink-400 transition"
                                title="Instagram">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                        ...
                        @if ($socialDiscord)
                            <a href="{{ e($socialDiscord) }}" target="_blank" rel="noopener noreferrer"
                                class="text-gray-500 hover:text-indigo-500 dark:hover:text-indigo-400 transition"
                                title="Discord">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
