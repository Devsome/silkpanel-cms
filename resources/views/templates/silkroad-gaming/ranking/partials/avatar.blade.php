...
<div>
    <section class="rounded-2xl border border-gray-800 bg-gray-900/50 backdrop-blur p-4 md:p-5">
                ...
                @foreach ($leftSlots as $slot)
                    ...
                    <div class="relative" x-data="{ show: false }" @mouseenter="show = true" @mouseleave="show = false"
                        ...
                        <button type="button" @click="show = !show"
                            class="relative inline-flex size-11 items-center justify-center border border-gray-700 bg-gray-800 p-0.5 transition hover:border-emerald-500"
                            title="Slot {{ $slot }}">
                            ...
                            @if ($item)
                                <span class="relative inline-flex size-9 items-center justify-center">
                                    ...
                                    <img src="{{ asset('images/silkroad/' . $item->get('icon')) }}"
                                        ...
                                        class="size-9 object-contain border border-emerald-500/30">
                                </span>
                            @else
                                <span class="size-9 border border-dashed border-gray-700/50"></span>
                            @endif
                        </button>
