            ...
            <main class="flex items-center justify-center px-6 py-12 lg:px-16"
                ...
                <div class="w-full max-w-md space-y-6">
                    ...
                    @if (session('status') == 'verification-link-sent')
                        <div class="bg-yellow-900/20 p-4 text-yellow-400 text-sm"
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full px-6 py-3 text-sm font-bold font-headline uppercase tracking-widest gp-card-low gp-text-on-surface-variant hover:text-yellow-400 transition">
