    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Welcome to SilkPanel CMS</h2>
                <p class="text-gray-600">Let's get your Silkroad Online panel up and running</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-primary-50 border border-primary-200 rounded-lg p-4">
                    <h3 class="font-semibold text-primary-900 mb-2">Before you begin, make sure you have:</h3>
                    <ul class="text-sm text-primary-800 space-y-1">
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-primary-500 mr-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7">
                                </path>
                            </svg>
                            Your MySQL & MSSQL database credentials
                        </li>
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-primary-500 mr-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            Valid SilkPanel API License Key
                        </li>
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-primary-500 mr-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center text-gray-700">
                                ...
                                Configure mail and storage settings
                            </div>
                            <div class="flex items-center text-gray-700">
                                <svg class="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
