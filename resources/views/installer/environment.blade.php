    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <div class="mb-8">
                ...
                <p class="text-gray-600">We're checking your server to make sure it meets SilkPanel CMS requirements</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <!-- Overall Status -->
                <div
                    class="border-2 {{ $checks['overall'] ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50' }} rounded-lg p-6">
                    <div class="flex items-center">
                        @if ($checks['overall'])
                            ...
                            <div>
                                ...
                                <p class="text-green-700">Your server meets all requirements for SilkPanel CMS installation.
                                </p>
                            </div>
                        @else
                            ...
                            <div>
                                ...
                                <p class="text-red-700">Please resolve the above issues before proceeding with installation.
                                </p>
                            </div>
                        @endif
                    </div>
            ...
            <div class="mt-8 flex justify-between">
                ...
                <div class="flex space-x-3">
                    ...
                    @if ($checks['overall'])
                        <a href="{{ route('installer.silkpanel') }}"
