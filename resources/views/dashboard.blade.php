                    ...
                    <div class="space-y-2">
                        ...
                        @if (Route::has('tickets.index') && $ticketSystemEnabled)
                            <a href="{{ route('tickets.index') }}"
                                class="flex items-center gap-3 px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-700/50 hover:bg-yellow-50 dark:hover:bg-yellow-900/20 text-sm text-gray-700 dark:text-gray-300 hover:text-yellow-700 dark:hover:text-yellow-300 transition">
                                <svg class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
