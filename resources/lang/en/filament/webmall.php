...
return [
    ...
    'col_custom_procedure'         => 'Custom Procedure',
    'col_custom_procedure_name'    => 'Procedure Name',
    'col_custom_database'          => 'Database',
    ...
    'field_custom_procedure'       => 'Custom Procedure',
    'field_custom_procedure_helper' => 'Required when item type is Custom Item.',
    'field_custom_database'        => 'Database Connection',
    'field_custom_procedure_name'  => 'Procedure Name',
    'field_custom_procedure_parameters' => 'Required Procedure Parameters',
    'field_custom_procedure_parameters_empty' => 'Select database and procedure to see required parameters.',
    'field_custom_procedure_parameters_unknown' => 'No parameters found (or none required).',
    'field_custom_parameters'      => 'Optional Custom Parameters',
    'field_custom_parameters_key'  => 'Parameter Name (e.g. @jid)',
    'field_custom_parameters_value' => 'Value or Token',
    'field_custom_parameters_helper' => 'No parameters are forwarded automatically. Define every procedure parameter explicitly here and use tokens for dynamic values.',
    'field_custom_parameter_tokens' => 'Available Value Tokens',
    'field_custom_parameter_tokens_helper' => '{jid}, {pjid}, {username}, {user_id}, {jid_or_pjid}, {charname}, {codename}, {amount} — {amount} resolves to the configured Amount above (defaults to 1).',
    'field_custom_image'           => 'Custom Item Image',
    'field_custom_image_helper'    => 'Upload an image for custom items displayed in WebMall.',
    'field_price_type'             => 'Price Type',
    'field_price'                  => 'Price',
    'field_amount'                 => 'Amount',
    'field_amount_helper'          => 'Quantity delivered per purchase. Only available for stackable items (Max Stack greater than 1); equipment is always delivered as a single item.',
    ...
    'col_status'                   => 'Status',
    'col_procedure_error'          => 'Procedure Error',
    'col_date'                     => 'Date',
